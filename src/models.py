...
'''Model
https://arxiv.org/pdf/2004.02678.pdf
'''

def loss_fn(predictions, targets, masks):
    ''' Active Loss function
    Args:
         predictions: the prediction from the model
         targets: the ground-truth of each movies
         masks: original data for [1], padding for [0]
    Returns:
        losses where masks for [1]
    '''
...
'''
Check the result of LGSS class
Don't need to run
'''
