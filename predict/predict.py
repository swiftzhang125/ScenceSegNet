...
def find_best_model(metric='validation_loss', last=True):
    '''Find best model according to different metric
    Args:
         metric: the name of metric validation_loss / mAP / mean_miou
         last: if same evaluation score return the last model
    Returns:
        the index of the model will be used in testset
    '''
...
def predict(metric='validation_loss', last=True):
    '''Make predictions
    Returns:
        mAP, AP_dict, mean_miou, miou_dict
    '''
